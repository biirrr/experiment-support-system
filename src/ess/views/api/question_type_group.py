...
@view_config(route_name='api.admin.question_type_group.collection.get', renderer='json')
@view_config(route_name='api.backend.question_type_group.collection.get', renderer='json')
...
@view_config(route_name='api.admin.question_type_group.item.patch', renderer='json')
